...
export default function App() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <section className="documents section reveal" id="documents"><Label number="09">ДОКУМЕНТЫ</Label><div className="documents-layout"><h2>Прочитать<br />до оплаты.</h2><div>{documents.map((item, index) => <button key={item} onClick={() => setActiveDocument(item)}><span className="mono">0{index + 1}</span><span>{item}</span><Arrow diagonal /></button>)}</div></div></section>
    </main>
